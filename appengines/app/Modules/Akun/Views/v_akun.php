  ...
  function editItem(event) {
    ...
    fetch("<?php echo site_url('akun/edit/') ?>" + id)
      ...
      .then(data => {
        ...
        // === Verifikasi: tidak ada default terpilih ===
        document.getElementById("verifikasi1").checked = false;
        document.getElementById("verifikasi0").checked = false;
        ...
        <div class="row mb-2">
          ...
          <div class="col">
            <div class="input-group">
              <input name="user_password" type="password" class="form-control" id="passwordInput"
                style="border-right: none;">
              <span class="input-group-text" id="togglePassword"
                style="background: white; cursor: pointer; border-left: none;">

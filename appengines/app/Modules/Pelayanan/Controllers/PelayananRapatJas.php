...
class PelayananRapatJas extends BaseController
{
  ...
  public function dataList()
  {
    ...
    // Subquery untuk mendapatkan kode_layanan yang memiliki detail dengan kode_jenis = 'D'
    ...
    // Query layanan dengan filter user_id dan kode_layanan yang valid
    $builder = $db->table($this->table);
    $builder->where('user_id', $user_id);
    $builder->whereIn('kode_layanan', $validLnKodes);
    $builder->orderBy('tanggal_checkout', 'DESC');
  ...
  public function submit_kuesioner()
  {
    ...
    $modelLayanan->updateData(['kuisioner' => 1, 'status_layanan' => 8], $this->id, $kode_layanan);

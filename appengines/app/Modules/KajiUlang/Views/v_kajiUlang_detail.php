      ...
      <div class="card-body">
        <div class="row mb-3 ps-3">
          ...
          <div class="col-12 col-md-4 border-start">
            ...
            <div class="fw-medium">
              <?php echo esc($layananData->tanggal_checkout ? date('d/m/Y H:i', strtotime($layananData->tanggal_checkout)) : '-'); ?>
            </div>
          </div>
          <div class="col-12 col-md-4 border-start">

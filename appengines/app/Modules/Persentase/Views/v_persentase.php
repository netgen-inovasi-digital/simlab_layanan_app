                ...
                <table id="data-table" class="saytable border-top-bottom">
                    <thead>
                        <tr>
                            ...
                            <th show>Kode Layanan</th>
                            <th show>Jenis Biaya</th>
                            <th show>Persentase</th>
...
<script>
    ...
    document.querySelector('#filterJenis').addEventListener('change', function() {
        ...
        let newUrl = apiUrl;
        if (kode !== "") {
            newUrl += (newUrl.includes("?") ? "&" : "?") + "kdJenKode=" + kode;
        }
                ...
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <select name="kdJenKode" class="form-control" required>
                            ...
                            <?php if (isset($jenis) && !empty($jenis)) : ?>
                                <?php foreach ($jenis as $j) : ?>
                                    <option value="<?php echo $j->jenKode; ?>"><?php echo $j->jenKode . ' - ' . $j->jenNama; ?></option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
                    </div>

  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <!-- [ADDED] Filter Status (status_layanan) -->
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered" role="document" style="max-width:1200px; margin: 1.5% auto;">
    <div class="modal-content">
      ...
      <div class="modal fade" id="modalUploadLhus" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-md" role="document" style="margin: 4% auto">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="formUploadLhus" action="<?php echo site_url('hasilpengujian/upload') ?>" method="post"
                ...
                <div class="mb-3">
                  ...
                  <div id="lhus-selection" class="form-text mt-2">Anda bisa unggah file baru untuk mengganti.
                  </div>
      ...
      <script>
        ...
        function loadSampleIdentity(kode_layanan) {
          ...
          if (cachedSampleData[kode_layanan]) {
            ...
            fetch(`<?php echo site_url("hasilpengujian/getSampleIdentity/") ?>${kode_layanan}`)
              .then(response => response.json())
              .then(data => {
        ...
        function loadDetail(id, kode_layanan) {
          console.log('loadDetail called with id:', id, 'kode_layanan:', kode_layanan);
          ...
          setTimeout(() => {
            ...
            if (modalDetailEl) {
              ...
              if (kode_layanan) {
                modalDetailEl.dataset.kode_layanan = kode_layanan;
              } else {
                kode_layanan = modalDetailEl.dataset.kode_layanan || '';
              }
            }
            ...
            setTimeout(async function () {
              try {
                ...
                if (btnKirim) {
                  // Set data-enc attribute
                  if (data.encLn) {
                    btnKirim.setAttribute('data-enc', data.encLn);
                  }

                  // Enable/disable button berdasarkan status file
                  console.log('allFilesUploaded status:', data.allFilesUploaded);
                  if (data.allFilesUploaded === true) {
                    btnKirim.removeAttribute('disabled');
                    btnKirim.classList.remove('disabled');
                    console.log('Button kirim ENABLED');
                  } else {
            ...
            loadSampleIdentity(kode_layanan);
          }, 200);
        }
      ...
      <script>
        ...
        /* [ADDED] Wiring dropdown Status → param status_layanan */
          ...
          sel.addEventListener('change', function () {
            ...
            if (table?.getConfig) {
              ...
              cfg.apiUrl = normalizeDoubleQuestion(
                buildApiUrlWithOptionalParam('<?php echo site_url("hasilpengujian/datalist") ?>', 'status_layanan', (val === '' ? null : val))
              );

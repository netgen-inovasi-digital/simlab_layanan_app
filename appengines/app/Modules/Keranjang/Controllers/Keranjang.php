...
class Keranjang extends BaseController
{
    ...
    // === tampilkan data keranjang (datatable ajax) === //
    ...
    // === tampilkan form ajax tambah data === //
...
public function checkout()
{
    ...
    // --- Ambil data user dari tabel simlab_account_users ---
    ...
    // Ambil data tambahan untuk header
    $email    = $emailFromDB;
    ...
    // Insert header layanan (sekali saja)
    ...
    // Insert detail (loop per item keranjang)

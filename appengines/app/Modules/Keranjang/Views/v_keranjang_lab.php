        ...
        <div>
          <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-3 gap-3">
            ...
            <div class="col-md-3">
              ...
              <input type="date" class="form-control" id="tglPelaksanaanLab" name="tglPelaksanaanLab" required>
            </div>
...
<script>
  ...
  if (!window.keranjangLabClickHandlerAttached) {
    window.keranjangLabClickHandlerAttached = true;
  ...
  } // End of keranjangLabClickHandlerAttached check

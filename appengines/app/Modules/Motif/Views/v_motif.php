...
<script>
    table = createTable({
        apiUrl: '<?php echo site_url("motif/datalist") ?>',
    });
    addAction();
...
<div class="modal fade" id="modalForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="margin: 2% auto">
        <div class="modal-content">
            ...
            <?php echo form_open('motif/submit', array('id' => 'myform', 'novalidate' => '')) ?>
            <div class="modal-body">
                <input type="hidden" value="" name="id" />
                <div class="row mb-2">
                    <div class="col">
                        <label class="col-md-3 col-form-label">Nama Motif</label>
                        <input name="name" type="text" class="form-control" required placeholder="Masukkan nama motif">
                    </div>
                    <div class="col">
                        <label class="col-md-3 col-form-label">Deskripsi</label>
                        <input name="deskripsi" type="text" class="form-control" required placeholder="Masukkan deskripsi singkat">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col">
                        <label class="col-md-5 col-form-label">Gambar (optional)</label>

...
class MyModel extends Model
{
	...
	// ===== mengambil semua data dengan join tabel dan urutan ===== //
	public function getAllDataByJoinWithOrder($joins = [], $where = [], $orderBy = [], $select = '*')
	{
	...
	public function getCountAll($where = null, $id = null)
	{

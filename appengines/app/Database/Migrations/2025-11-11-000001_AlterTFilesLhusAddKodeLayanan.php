...
class AlterTFilesLhusAddKodeLayanan extends Migration
{
  public function up()
  {
    ...
    if (!$this->db->fieldExists('kode_layanan', 't_files_lhus')) {
      ...
      $this->db->query('ALTER TABLE t_files_lhus ADD CONSTRAINT fk_lhus_kode_layanan FOREIGN KEY (kode_layanan) REFERENCES t_layanan(kode_layanan) ON DELETE CASCADE ON UPDATE CASCADE');
    }
